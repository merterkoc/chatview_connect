...
- Clone the forked repository to your local development machine
  (e.g. `git clone git@github.com:<YOUR_GITHUB_USER>/chatview_connect.git`).
...
Go to the [pull request page of ChatView Connect][PRs] and in the top
...
mark (e.g. `feat!: Add support for group chat`).

Examples of PR titles:

- feat: ✨ Added smooth transition for real-time message updates
- fix: 🐛 Fixed duplicate key issue in chat messages
- docs: 💡 Updated documentation for `getChatsStream` method
- docs: 📚 Enhanced `ChatRoomManager` section in README
- test: 🚨 Added unit test for sending messages to the database
- refactor: 🔨 Optimized cloud chat service structure in example

## Maintainers

These instructions are for the maintainers of ChatView Connect.
...
[GitHub issue]: https://github.com/SimformSolutionsPvtLtd/chatview_connect/issues/new

[GitHub issues]: https://github.com/SimformSolutionsPvtLtd/chatview_connect/issues/new
...
[PRs]: https://github.com/SimformSolutionsPvtLtd/chatview_connect/pulls
